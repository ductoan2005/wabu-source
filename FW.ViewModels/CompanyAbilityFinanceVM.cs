...
{
    public class CompanyAbilityFinanceVM
    {
        ...
        public HttpPostedFileBase EvidenceCheckSettlementFile { get; set; } //Biên bản kiểm tra quyết toán
        public HttpPostedFileBase EvidenceDeclareTaxFile { get; set; } //Tờ khai tự quyết toán thuế
        public HttpPostedFileBase EvidenceCertificationTaxFile { get; set; } //Văn bản xác nhận của cơ quan quản lý thuế
        public HttpPostedFileBase EvidenceAuditReportFile { get; set; } //Báo cáo kiểm toán.
