...
{
    public class CompanyAbilityEquipmentVM
    {
        ...
        public HttpPostedFileBase EvidenceSaleContractFile { get; set; } //Hợp đồng mua bán
        public HttpPostedFileBase EvidenceInspectionRecordsFile { get; set; } //Hồ sơ kiểm định
